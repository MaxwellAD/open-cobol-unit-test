       ...
       *> GOOD TIME TO IMPLEMENT "TIMES" KEYWORD
       ...
       TEST-ASSERT-CONTAINS-FAIL SECTION.
           ...
           *> THEN
           ...
           IF NOT DUT-TEST-FAIL 
              STRING 'DUT DIDNT FAIL THE CASE WHEN IT SHOULD HAVE'
              DELIMITED BY SIZE INTO CUT-DISPLAY-FAIL-MSG 
              PERFORM CUT-FAIL 
           END-IF
       ...
       TEST-ASSERT-CONTAINS-BOUNDARY SECTION.
           ...
           *> THEN
           *> EITHER ASSERTION FAILING LEAVES THE DUT CASE FAILED
           IF DUT-TEST-FAIL
              STRING 'DUT FAILED THE CASE WHEN IT SHOULD HAVE PASSED'
              DELIMITED BY SIZE INTO CUT-DISPLAY-FAIL-MSG
              PERFORM CUT-FAIL
       ...
       TEST-ASSERT-CONTAINS-CASE SECTION.
           *> THE MATCH IS CASE SENSITIVE - THIS PINS THAT DOWN SO IT
           *> CANNOT CHANGE WITHOUT A TEST SAYING SO
       ...
       TEST-ASSERT-CONTAINS-LONGER SECTION.
           ...
           *> OFF THE END OF THE ACTUAL - RUN IT UNDER -debug
       ...
       TEST-ASSERT-CONTAINS-NO-TARGET SECTION.
           ...
           *> THEN
           IF NOT DUT-TEST-ERROR
              STRING 'DUT DID NOT ERROR ON AN EMPTY TARGET'
              DELIMITED BY SIZE INTO CUT-DISPLAY-FAIL-MSG
              PERFORM CUT-FAIL
           END-IF
       ...
       TEST-ASSERT-CONTAINS-NUM-SET SECTION.
           ...
           *> THEN
           IF NOT DUT-TEST-ERROR
              STRING 'DUT DID NOT ERROR ON A NUMERIC TARGET'
              DELIMITED BY SIZE INTO CUT-DISPLAY-FAIL-MSG
              PERFORM CUT-FAIL
           END-IF
