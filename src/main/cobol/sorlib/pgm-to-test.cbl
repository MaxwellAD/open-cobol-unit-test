      ...
      * USAGE: INTERNAL
      * DESCRIPTION:
      * SETS THE RETURN CODE BASED ON THE RESULT OF THE TEST SUITE
       DUT-SET-RETURN-CODE SECTION.
      ...
      * AS A FORMATTED TABLE WITH SECTION NAMES AND FIELD VALUES
       DUT-DEBUG-DISPLAY-TRACE SECTION.
           MOVE '[DEBUG] EXECUTION TRACE TABLE' TO DUT-OUT-RECORD
           PERFORM DUT-WRITE-UT-RECORD 
